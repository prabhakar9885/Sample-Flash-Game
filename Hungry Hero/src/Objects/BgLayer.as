package Objects
{
	...
	public class BgLayer extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			trace("Stage dimensions: "+stage.width+" x "+stage.height);
			trace("Stage dimensions: "+stage.stageWidth+" x "+stage.stageHeight);
			trace("Image1: ("+image1.x+","+image1.y+ ")");
			
			image2.x = image2.width;
			image2.y = image1.y;
			trace("Image2: ("+image2.x+","+image2.y+ ")");
