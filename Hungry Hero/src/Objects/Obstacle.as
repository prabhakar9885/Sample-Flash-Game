	...
	public class Obstacle extends Sprite
	{
		...
		public function set alreadyHit(value:Boolean):void
		{
			...
			if(value)
			{
				...
				if(this._type == 4)	obstacleAnimation.visible = false;
		...
		private function createWatchOutAnimation():void
		{
			...
			if(_type == 4)
			{
				...
				watchOutAnimation.y= obstacleAnimation.y + obstacleAnimation.texture.height/2 - watchOutAnimation.texture.height/2;
			}
			else
			{
				watchOutAnimation.x= -watchOutAnimation.texture.width;
				watchOutAnimation.y= obstacleImage.y + obstacleImage.texture.height/2 - watchOutAnimation.texture.height/2;
			}
